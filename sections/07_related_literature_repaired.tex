...
The paper combines nonlinear service pricing, commitment, sunk integration, and dynamic tariff choice. These ingredients are established separately in prior work and are not claimed as new; the contribution is the feedback from an architecture-induced installed state back into the profitability of that same architecture.
